...
- **US-intl cedilla and toolbar indicator.** US and US International layouts are active via Hyprland, with no custom toolbar indicator. The attempted cloned keyboard-layout widget did not update reliably. The `~/.XCompose` cedilla mapping is present but still needs testing. Revisit with a tested Hyprland/XKB or GTK cedilla solution and optional indicator customization.
